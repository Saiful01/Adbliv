...
<div id="loading">
    <div id="loading-center">
        <img src="/theme/images/loader.gif" alt="loder">
    </div>
</div>
<!-- loading End -->
<!-- Header -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="menu-logo">
                            <li>
                                <a href="index.html"><img src="/theme/images/logo.png" alt="logo" class="img-fluid"></a>
                            </li>
                        </ul>
                        <!-- menu search bar -->
                        ...
                        <ul class="menu-links">
                            ...
                            <li>
                                ...
                                <ul class="drop-down-multilevel ">
                                    <li>
                                        <a href="javascript:void(0)">  About <i class="fas fa-angle-right "></i></a>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">  Other Pages <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"> Services <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">Team <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">Login Register <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                            ...
                            <li>
                                ...
                                <ul class="drop-down-multilevel">
                                    <li>
                                        <a href="javascript:void(0)"> Blog Details <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"> Blog Grid <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                            <li><a href="all-blog-grid.html">All Blog Grid</a></li>
                                            <li><a href="blog-grid-left-sidebar.html">Blog Grid Left Sidebar</a></li>
                                            <li><a href="blog-grid-right-sidebar.html">Blog Grid Right Sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"> Blog List <i class="fas fa-angle-right "></i></a>
                                        <!-- drop down third level -->
                                        <ul class="drop-down-multilevel">
                                            <li><a href="all-blog-list.html">All Blog List</a></li>
        ...
        <div id="rev_slider_3_1" class="rev_slider fullwidthabanner tp-overflow-hidden" style="display:none;" data-version="5.2.6">
            <ul>  <!-- SLIDE  -->
                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="600"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="revslider/assets/02f6c-bg.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <h1 class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 5; white-space: nowrap; font-size: 60px; line-height: 70px; font-weight: 700; color: rgba(27, 14, 61, 1.00);font-family:Nunito;">More Possibilities <br> with Markethon </h1>
                    <!-- LAYER NR. 2 -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9;"><img src="revslider/assets/edad9-08.png" alt="" data-ww="636px" data-hh="411px" data-no-retina> </div>
                    <!-- LAYER NR. 6 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-7"
                         data-x="895"
                         ...
                         style="z-index: 10;"><img src="revslider/assets/69d21-04.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-8"
                         data-x="1045"
                         ...
                         style="z-index: 11;"><img src="revslider/assets/77014-05.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-9"
                         data-x="1196"
                         ...
                         style="z-index: 12;"><img src="revslider/assets/7ae95-06.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 9 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-17"
                         data-x="858"
                         ...
                         style="z-index: 13;"><img src="revslider/assets/b2422-10.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 10 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-15"
                         data-x="798"
                         ...
                         style="z-index: 14;"><img src="revslider/assets/bc86e-12.png" alt="" data-ww="537px" data-hh="250px" data-no-retina> </div>
                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-16"
                         data-x="1128"
                         ...
                         style="z-index: 15;"><img src="revslider/assets/b1482-09.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 12 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-2-layer-18"
                         data-x="764"
                         ...
                         style="z-index: 16;"><img src="revslider/assets/b33c3-11.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9;"><img src="revslider/assets/618b3-09.png" alt="" data-ww="607px" data-hh="449px" data-no-retina> </div>
                    <!-- LAYER NR. 6 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-18"
                         data-x="746"
                         ...
                         style="z-index: 10;"><img src="revslider/assets/46e39-02.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-16"
                         data-x="1147"
                         ...
                         style="z-index: 11;"><img src="revslider/assets/ca039-06.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-17"
                         data-x="750"
                         ...
                         style="z-index: 12;"><img src="revslider/assets/46281-03.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 9 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-19"
                         data-x="881"
                         ...
                         style="z-index: 13;"><img src="revslider/assets/ca039-06.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 10 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-20"
                         data-x="1015"
                         ...
                         style="z-index: 14;"><img src="revslider/assets/ca039-06.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-21"
                         data-x="758"
                         ...
                         style="z-index: 15;"><img src="revslider/assets/cbb91-07.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 12 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-24"
                         data-x="692"
                         ...
                         style="z-index: 16;"><img src="revslider/assets/34673-14.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 13 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-25"
                         data-x="914"
                         ...
                         style="z-index: 17;"><img src="revslider/assets/63023-12.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 14 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-22"
                         data-x="809"
                         ...
                         style="z-index: 18;"><img src="revslider/assets/41966-15.png" alt="" data-ww="436px" data-hh="172px" data-no-retina> </div>
                    <!-- LAYER NR. 15 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-3-layer-23"
                         data-x="1097"
                         ...
                         style="z-index: 19;"><img src="revslider/assets/b7030-13.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <h1 class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 5; white-space: nowrap; font-size: 60px; line-height: 70px; font-weight: 700; color: rgba(27, 14, 61, 1.00);font-family:Nunito;">Growing business <br>is new clients </h1>
                    <!-- LAYER NR. 2 -->
                    <p class="tp-caption   tp-resizeme"
                       id="slide-4-layer-2"
                       data-x="34"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9;"><img src="revslider/assets/17ea3-01.png" alt="" data-ww="628px" data-hh="405px" data-no-retina> </div>
                    <!-- LAYER NR. 6 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-17"
                         data-x="892"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 13;"><img src="revslider/assets/69d21-04.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 10 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-22"
                         data-x="893"
                         ...
                         style="z-index: 14;"><img src="revslider/assets/242a2-08.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-23"
                         data-x="1033"
                         ...
                         style="z-index: 15;"><img src="revslider/assets/7ae95-06.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 12 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                         ...
                         style="z-index: 16;"><img src="revslider/assets/a805a-11.png" alt="" data-ww="217px" data-hh="328px" data-no-retina> </div>
                    <!-- LAYER NR. 13 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                         id="slide-4-layer-25"
                         data-x="1144"
                         ...
                         style="z-index: 17;"><img src="revslider/assets/b3bdd-12.png" alt="" data-ww="225px" data-hh="311px" data-no-retina> </div>
                    <!-- LAYER NR. 14 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-27"
                         data-x="1027"
                         ...
                         style="z-index: 18;"><img src="revslider/assets/64173-15.png" alt="" data-ww="59px" data-hh="37px" data-no-retina> </div>
                </li>
            </ul>
...
<div class="main-content">
    ...
    <section class="iq-works main-bg position-relative">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 text-center">
                    <div class="iq-workinfo">
                        <div class="service-shap  mb-4 iq-rmt-40">
                            <img src="/theme/images/work/01.png" class="img-fluid " alt="">
                        </div>
                ...
                <div class="col-lg-4 text-center">
                    <div class="iq-workinfo">
                        <div class="service-shap  mb-4 iq-rmt-40">
                            <img src="/theme/images/work/02.png" class="img-fluid " alt="">
                        </div>
                ...
                <div class="col-lg-4 text-center">
                    <div class="iq-workinfo">
                        <div class="service-shap  mb-4 iq-rmt-40">
                            <img src="/theme/images/work/03.png" class="img-fluid " alt="">
                        </div>
        ...
        <div class="iq-way">
            <img src="/theme/images/work/2.png" class="img-fluid"  alt="image">
        </div>
    </section>
    <!-- Works END -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="position-relative">
                        <img  src="/theme/images/video/2.png" class="img-fluid w-100" alt="">
                        <div class="waves-box">
                        ...
                        <div class="video-people">
                            <div class="scrollme">
                                <img src="/theme/images/video/1.png" class="img-fluid one animateme"
                                     data-when="span"
                                     data-from="1"
                                     data-to="0"
                            ...
                            <div class="scrollme">
                                <img src="/theme/images/video/3.png" class="img-fluid two animateme"
                                     data-when="span"
                                     data-from="1"
                                     data-to="0"
                                     data-translatex="300" alt="image">
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                <div class="col-lg-6 align-self-center text-center">
                    <img src="/theme/images/others/3.png" class="img-responsive img-fluid wow fadeInRight" id="img" alt="image">
                </div>
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="col-lg-6 text-center wow fadeInLeft">
                    <img src="/theme/images/others/2.jpg" class="img-fluid iq-rmt-40" alt="image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="iq-project position-relative pt-0">
        <div class="scrollme">
            <img src="/theme/images/others/13.png" class="img-fluid project-overlay-left animateme"
                 data-when="enter"
                 data-from="0.5"
                 data-to="0"
                    ...
                    <div id="portfolio-carousel" class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="false" data-items="4" data-items-laptop="3" data-items-tab="3" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                        <div class="item">
                            <div class="iq-portfolio">
                                <img src="/theme/images/project/1.png" class="img-fluid" alt="image">
                        ...
                        <div class="item">
                            <div class="iq-portfolio">
                                <img src="/theme/images/project/2.png" class="img-fluid" alt="image">
                                <div class="portfolio-info">
                                    <a href="#"><span class="text-black">Design Concept</span></a>
                                    <a href="#" class="text-uppercase text-gray float-right">Design</a>
                                </div>
                        ...
                        <div class="item">
                            <div class="iq-portfolio">
                                <img src="/theme/images/project/3.png" class="img-fluid" alt="image">
                                <div class="portfolio-info">
                                    <a href="#"><span class="text-black">Design Concept</span></a>
                                    <a href="#" class="text-uppercase text-gray float-right">Design</a>
                                </div>
                        ...
                        <div class="item">
                            <div class="iq-portfolio">
                                <img src="/theme/images/project/4.png" class="img-fluid" alt="image">
                                <div class="portfolio-info">
                                    <a href="#"><span class="text-black">Design Concept</span></a>
                                    <a href="#" class="text-uppercase text-gray float-right">Design</a>
                                </div>
    ...
    <section class="iq-works position-relative pt-0">
        ...
        <img src="/theme/images/others/16.png" class="img-fluid iqwork-two" alt="image">
    </section>
    <!-- Works END -->
    <!-- Our Clients -->
    <section class="iq-ourclients iq-rmt-40">
        <div class="scrollme">
            <img src="/theme/images/service/1.png"  class="img-fluid service-one animateme"
                 data-when="enter"
                 data-from="0.5"
                 data-to="0"
                ...
                <div class="col-lg-12">
                    <div id="testimonial-slider" class="owl-carousel owl-theme owl-loaded iq-mt-50" data-dots="true" data-nav="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-autoplay="true">
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/01.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/02.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/03.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/04.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/05.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/06.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                        ...
                        <div class="testimonial-box">
                            <img src="/theme/images/testimonials/07.jpg" class="img-fluid mb-3 img-shap " alt="">
                            <p class="description">
                                Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                            </p>
                            <h6>Haris Morgan <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Markethon</span></span></h6>
            ...
            <div class="row  no-gutters ">
                <div class="col-lg-12">
                    <div class=" pricing-info">
                        <div class="row">
                            <div class="col-lg-2 col-sm-12"> <img src="/theme/images/pricing/1.png" class="img-fluid" alt="image"></div>
                ...
                <div class="col-lg-12">
                    <div class=" pricing-info active border-top-0 border-bottom-0">
                        <div class="row">
                            <div class="col-lg-2 col-sm-12"> <img src="/theme/images/pricing/2.png" class="img-fluid" alt="image"></div>
                            <div class="col-lg-7 col-sm-12 align-self-center">
                                <div class="pricing-plan">
                                    <div class="section-title mb-3">
                ...
                <div class="col-lg-12">
                    <div class=" pricing-info">
                        <div class="row">
                            <div class="col-lg-2 col-sm-12"> <img src="/theme/images/pricing/3.png" class="img-fluid" alt="image"></div>
                            <div class="col-lg-7 col-sm-12 align-self-center">
                                <div class="pricing-plan">
                                    <div class="section-title mb-3">
    ...
    <section class="iq-blogs position-relative iq-rmt-40">
                ...
                <div class="col-lg-12">
                    <div class="owl-carousel"  data-loop="true" data-nav="false" data-dots="false" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1">
                        <div class="item">
                            <div class="main-blog">
                                <div class="blog-img">
                                    <img src="/theme/images/blog/01.jpg" class="img-fluid" alt="image">
                                </div>
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-info">
                                        <a href="#"><img src="/theme/images/blog/clients/01.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">John Deo</span></a>
                        ...
                        <div class="item">
                            <div class="main-blog">
                                <div class="blog-img">
                                    <img src="/theme/images/blog/02.jpg" class="img-fluid" alt="image">
                                </div>
                                <div class="blog-detail">
                                    <a class="main-color iq-fw-8" href="blog-details-left-sidebar.html">Design Concept</a>
                                    ...
                                    <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                                    <div class="blog-info">
                                        <a href="#"><img src="/theme/images/blog/clients/02.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Kips Leo</span></a>
                                        <ul class="d-inline-block float-right">
                                            <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                                            <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                                        </ul>
                        ...
                        <div class="item">
                            <div class="main-blog">
                                <div class="blog-img">
                                    <img src="/theme/images/blog/03.jpg" class="img-fluid" alt="image">
                                </div>
                                <div class="blog-detail">
                                    <a class="main-color iq-fw-8" href="blog-details-left-sidebar.html">Design Concept</a>
                                    ...
                                    <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                                    <div class="blog-info">
                                        <a href="#"><img src="/theme/images/blog/clients/03.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Glen Jax </span></a>
                                        <ul class="d-inline-block float-right">
                                            <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                                            <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                                        </ul>
                        ...
                        <div class="item">
                            <div class="main-blog">
                                <div class="blog-img">
                                    <img src="/theme/images/blog/04.jpg" class="img-fluid" alt="image">
                                </div>
                                <div class="blog-detail">
                                    <a class="main-color iq-fw-8" href="blog-details-left-sidebar.html">Design Concept</a>
                                    ...
                                    <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                                    <div class="blog-info">
                                        <a href="#"><img src="/theme/images/blog/clients/04.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">JD Scot</span></a>
                                        <ul class="d-inline-block float-right">
                                            <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                                            <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                                        </ul>
                        ...
                        <div class="item">
                            <div class="main-blog">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                                    <div class="blog-info">
                                        <a href="#"><img src="/theme/images/blog/clients/05.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Nils Leo</span></a>
                                        <ul class="d-inline-block float-right">
                                            <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                                            <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                                        </ul>
        ...
        <div class="scrollme">
            <img src="/theme/images/blog/05.png" class="img-fluid blog-one animateme" data-when="exit"
                 data-from="0.5"
                 data-to="0"
                 data-translatex="50"
                 alt="#">
            ...
            <div class="row">
                <div id="clients-slider" class="owl-carousel owl-theme owl-loaded " data-dots="false" data-nav="false" data-items="5" data-items-laptop="5" data-items-tab="4" data-items-mobile="3" data-items-mobile-sm="2" data-autoplay="true" data-margin="30">
                    <div class="clients-box">
                        <img src="/theme/images/clients/9.png" class="img-fluid " alt="">
                    </div>
                    <div class="clients-box">
                        <img src="/theme/images/clients/10.png" class="img-fluid " alt="">
                    </div>
                    <div class="clients-box">
                        <img src="/theme/images/clients/11.png" class="img-fluid " alt="">
                    </div>
                    <div class="clients-box">
                        <img src="/theme/images/clients/12.png" class="img-fluid " alt="">
                    </div>
                    <div class="clients-box">
                        <img src="/theme/images/clients/9.png" class="img-fluid " alt="">
                    </div>
...
<footer class="footer-one footer-bg  position-relative">
    <img src="/theme/images/footer/4.png" class="img-fluid fshap-after" alt="image">
            ...
            <div class="row ">
                <div class="col-lg-4 col-md-6">
                    <div class="iq-footer-logo">
                        <a href="index.html"><img src="/theme/images/footer/logo.png" class="img-fluid" alt="image"></a>
                    </div>
